...
public class DefaultStorIOSQLite extends StorIOSQLite {
    ...
    @NonNull
    private final ChangesBus<Changes> changesBus = new ChangesBus<>();
    ...
    protected DefaultStorIOSQLite(
            ...
            @NonNull CoroutineDispatcher defaultDispatcher,
    ...
    @NonNull
    @Override
    public Flow<Changes> observeChanges() {
        return changesBus.asFlow();
    }
    ...
    @Override
    @NonNull
    public Flow<Changes> observeChangesInTables(@NonNull final Set<String> tables) {
    ...
    @Override
    @NonNull
    public Flow<Changes> observeChangesOfTags(@NonNull final Set<String> tags) {
        // indirect usage of RxJava filter() required to avoid problems with ClassLoader when RxJava is not in ClassPath
    ...
    public static final class CompleteBuilder {
        ...
        @NonNull
        private CoroutineDispatcher defaultDispatcher = Dispatchers.getIO();
        ...
        /**
         * Optional: Specifies a scheduler on which {@link Flow} will be subscribed.
         *
         * @return builder.
         */
        @NonNull
        public CompleteBuilder defaultDispatcher(@NonNull CoroutineDispatcher defaultDispatcher) {
            this.defaultDispatcher = defaultDispatcher;
            return this;
        }
        ...
        public DefaultStorIOSQLite build() {
            ...
            return new DefaultStorIOSQLite(sqLiteOpenHelper, typeMappingFinder, defaultDispatcher, interceptors);
        }
    }
